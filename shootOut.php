...
<html>
	...
	<body>
		<div data-role="header" id="header" class="ui-header ui-bar-a" role="banner">
			...
			<h1 class="ui-title" tabindex="0" role="heading" aria-level="1">Shoot Out</h1>
		...
		<div data-role="content" id="topShoot">
			<p>
				The reality of the matter is that a shooting can happen anywhere at any time. And if you are unfortunate enough to find yourself in the same place as a shooter, whether you're at school or in a workplace, it's best to be prepared. If you can run away reasonably safely, that should always be your first move. If not, you need to hide and barricade yourself. And if you come face to face with a shooter, then you will need to fight for your life. If you want to know how to survive a school or workplace shooting, follow these steps.
			</p>

			<h1>Method 1 of 4: Running Away</h1>
			<p>
				<img src="images/Method1Pic1.jpg" width="100%">
				<h2>1</h2>
			...
			<p>
				<img src="images/Method1Pic2.jpg" width="100%">
				<h2>2</h2>
			...
			<p>
				<img src="images/Method1Pic3.jpg" width="100%">
				<h2>3</h2>
			...
			<p>
				<img src="images/Method1Pic4.jpg" width="100%">
				<h2>4</h2>
			...
			<p>
				<img src="images/Method1Pic5.jpg" width="100%">
				<h2>5</h2>
			...
			<p>
				<img src="images/Method1Pic6.jpg" width="100%">
				<h2>6</h2>
				Cover your tracks if you can. If you have the time, grab a fire extinguisher and create a path of smoke behind you so the shooter will have a harder time pursuing you. Keep the extinguisher and other sharp objects that can be used as weapons if you face the shooter. But don't waste time looking for weapons or ways to cover your tracks if it'll keep you from escaping.
			</p>

			<h1>Method 2 of 4:  Hiding and Barricading Yourself</h1>
			<p>
				<img src="images/Method2Pic1.jpg" width="100%">
				<h2>1</h2>
			...
			<p>
				<img src="images/Method2Pic2.jpg" width="100%">
				<h2>2</h2>
			...
			<p>
				<img src="images/Method2Pic3.jpg" width="100%">
				<h2>3</h2>
			...
			<p>
				<img src="images/Method2Pic4.jpg" width="100%">
				<h2>4</h2>
			...
			<p>
				<img src="images/Method2Pic5.jpg" width="100%">
				<h2>5</h2>
			...
			<p>
				<img src="images/Method2Pic6.jpg" width="100%">
				<h2>6</h2>
			...
			<p>
				<img src="images/Method2Pic7.jpg" width="100%">
				<h2>7</h2>
			...
			<p>
				<img src="images/Method2Pic8.jpg" width="100%">
				<h2>8</h2>
				Consider playing dead if you can't hide yourself. This only works if shots have been fired and you're already in a room or place when people have been shot and have no place to hide. Then, if the shooter approaches your location, you can take a risk and play dead, hoping that he'll think that you're among the dead and will pass you by. However, this is a risky move because he may not believe you're dead, and you may be too nervous to stay completely still.
			</p>
			<p>
				<img src="images/Method2Pic9.jpg" width="100%">
				<h2>9</h2>
			...
			<p>
				<img src="images/Method2Pic10.jpg" width="100%">
				<h2>10</h2>
			...
			<h1>Method 3 of 4: Attacking the Shooter</h1>
			<p>
				<img src="images/Method3Pic1.jpg" width="100%">
				<h2>1</h2>
			...
			<p>
				<img src="images/Method3Pic2.jpg" width="100%">
				<h2>2</h2>
			...
			<p>
				<img src="images/Method3Pic3.jpg" width="100%">
				<h2>3</h2>
			...
			<p>
				<img src="images/Method3Pic4.jpg" width="100%">
				<h2>4</h2>
			...
			<p>
				<img src="images/Method3Pic5.jpg" width="100%">
				<h2>5</h2>
			...
			<h1>Method 4 of 4: Preventing or Preparing for a School or Workplace Shooting</h1>
			<p>
			...
			<br>
			<a data-ajax="false" data-role="button" href="#topShoot">Back to top</a>
