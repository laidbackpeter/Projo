...
<html>
	...
	<body>
		<div data-role="header" id="header" class="ui-header ui-bar-a" role="banner">
			...
			<h1 class="ui-title" tabindex="0" role="heading" aria-level="1">Fire</h1>
		...
		<div data-role="content" id="topFire" >
			...
			<p>
				<img src="images/FireM1Step3.jpg" width="100%">
				<h2>3</h2>
			...
			<p>
				<img src="images/FireM1Step4.jpg" width="100%">
				<h2>4</h2>
				Stop, drop, and roll if your clothes catch fire. If your clothes catch fire, immediately stop what you're doing, drop flat to the ground, and roll around until you put the fire out. Rolling around will smother the fire quickly. Cover your face with your hands as you're rolling to protect yourself.

			</p>
			<p>
				<img src="images/FireM1Step5.jpg" width="100%">
				<h2>5</h2>
			...
			<p>
				<img src="images/FireM1Step6.jpg" width="100%">
				<h2>6</h2>
			...
			<h1>Method 2 of 3: What to do Once You Exit Your Home</h1>
			<p>
				<img src="images/FireM2Step1.jpg" width="100%">
				<h2>1</h2>
			...
			<p>
				<img src="images/FireM2Step2.jpg" width="100%">
				<h2>2</h2>
				Call your local emergency services number. Use your cellphone or call from a neighbor's house. A list of emergency contacts are available <a href="contacts.php"> here.</a>
			</p>
			<p>
				<img src="images/FireM2Step3.jpg" width="100%">
				<h2>3</h2>
				Do an injury assessment. After making the call and the resources are coming, it is time to check yourself and family members to make sure that there are no injuries. If there are, do what you can to address that and when the fire department arrives, you can ask for directions and help.

			</p>
			<p>
				<img src="images/FireM2Step4.jpg" width="100%">
				<h2>4</h2>
				Get away from the structure. Keep a safe distance between you and the fire. Take the necessary measures after the house fire to be safe.
			</p>

			<h1>Method 3 of 3: Preventing Future House Fires</h1>
			<p>
				<img src="images/FireM3Step1.jpg" width="100%">
				<h2>1</h2>
				Form and practice your family's escape plan. The best way to prevent house fires is for your family to have a plan of escape in the event of a fire. You should form your plan and practice it at least twice a year to get comfortable with the routine and to ensure that you'll be clear-headed enough to carry out your plan if the time ever comes. Here are some things to keep in mind as you do this:
				<ul>
					<li>
			...
			<p>
				<img src="images/FireM3Step3.jpg" width="100%">
				<h2>3</h2>
				Practice safe behaviors. To prevent your house from catching fire in the first place, there are some safety precautions that you should take:
				<ul>
					<li>
			...
			<br>
			<a data-ajax="false" data-role="button" href="#topFire">Back to top</a>
