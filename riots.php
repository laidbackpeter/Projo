...
<html>
	...
	<body>
		<div data-role="header" id="header" class="ui-header ui-bar-a" role="banner">
			...
			<h1 class="ui-title" tabindex="0" role="heading" aria-level="1">Riots</h1>
		...
		<div data-role="content" id="topRiots">
			<p>
			...
			<h1>Method 1 of 2: Surviving a Riot</h1>
			<p>
				<img src="images/RiotM1Pic1.jpg" width="100%">
				<h2>1</h2>
				...
				<ul>
					<li>
						Get familiar with your area. If you're just visiting for a summer of new in the neighborhood, you should still get to know your location as intimately as possible. Study a map until you're very comfortable with the area where you work, the area where you live, and the passages in between.
					</li>
					<li>
			...
			<p>
				<img src="images/RiotM1Pic2.jpg" width="100%">
				<h2>2</h2>
			...
			<p>
				<img src="images/RiotM1Pic3.jpg" width="100%">
				<h2>3</h2>
			...
			<p>
				<img src="images/RiotM1Pic4.jpg" width="100%">
				<h2>4</h2>
			...
			<p>
				<img src="images/RiotM1Pic5.jpg" width="100%">
				<h2>5</h2>
			...
			<p>
				<img src="images/RiotM1Pic6.jpg" width="100%">
				<h2>6</h2>
			...
			<p>
				<img src="images/RiotM1Pic7.jpg" width="100%">
				<h2>7</h2>
			...
			<p>
				...
				<ul>
					...
					<li>
						Move to rooms that do not lead directly outside, to avoid getting hit by stones or bullets.
					</li>
					<li>
			...
			<p>
				<img src="images/RiotM1Pic9.jpg" width="100%">
				<h2>9</h2>
			...
			<p>
				...
				<h2>2</h2>
				Bring a solution for rinsing your eyes in case you're exposed to tear gas. If you're worried that you may be exposed to tear gas, you should bring a solution of half liquid antacid and half water (spray is better than stream and it's available in many drug stores and larger stores) and use it to rinse eyes in case you are exposed to tear gas.
				<ul>
					<li>
				...
				<img src="images/RiotM2Pic2.jpg" width="100%">
				<ul>
					Another good thing to bring is a rag soaked in lemon juice or vinegar in a plastic bag, this can be used to breathe through for some protection against gas.</li>
				</ul>
				<img src="images/RiotM2Pic22.jpg" width="100%">
			</p>

			<p>
				<img src="images/RiotM2Pic3.jpg" width="100%">
				<h2>3</h2>
			...
			<p>
				<img src="images/RiotM2Pic4.jpg" width="100%">
				<h2>4</h2>
				Carry an extra cell phone. If you're walking around a high-risk area, you should take your telephone, two if possible (one in your pocket and one in a bag). If one is lost or taken, you still have another one.

			</p>
			<p>
				<img src="images/RiotM2Pic5.jpg" width="100%">
				<h2>5</h2>
			...
			<p>
				...
				<img src="images/RiotM2Pic6.jpg" width="100%">
				<ul>
					<li>
				...
				<img src="images/RiotM2Pic62.jpg" width="100%">
				<ul>
					<li>
				...
				<img src="images/RiotM2Pic63.jpg" width="100%">
				<ul>
					<li>
			...
			<br>
			<a data-ajax="false" data-role="button" href="#topRiots">Back to top</a>
