		...
		<div data-role="content" id="content" data-theme="a" data-content-theme="a" style="width: 100%; padding: 0;">
			<div id="map_canvas" style="width:100%; height:300px">
				...
				function initialize() {
					...
					directionsDisplay.setPanel(document.getElementById("directionsPanel"));
						...
						function calcRoute(start) {
							...
							var end = '-1.274309, 36.822631';

							console.log("jhsfdkj: " + start);
				...
				<div data-role="content" id="content" data-theme="e" data-content-theme="e">
					<p>
						<?php include("display.php"); displayDonation(); ?>				</p>
					...
					<div data-role="content" id="content" data-theme="e" data-content-theme="e">
						<a href="index.html" data-role="button" data-icon="refresh">Recalculate</a>
					</div></br></br>
